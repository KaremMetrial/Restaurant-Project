                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.why-choose-us.update', $whyChooseUs->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Icon</label>
                            <br>
                            <button data-icon="{{ $whyChooseUs->icon }}" class="btn btn-primary iconpicker-component" name="icon" role="iconpicker" ></button>
                        </div>
                        <!-- Icon-->
                        ...
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" class="form-control" name="title" value="{{ old('title', $whyChooseUs->title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" required
                                      autofocus>{{ old('short_description', $whyChooseUs->short_description) }}</textarea>
                        </div>
                        <!-- Short Description-->
                        ...
                        <div class="form-group">
                            ...
                            <label class="custom-switch mt-2">
                                <input type="checkbox" name="status" value="1"
                                       class="custom-switch-input" {{ old('status', $whyChooseUs->status) ? 'checked' : '' }}>
